...
| 06        | P0        | Docker Compose + Makefile zaimplementowane: setup/doctor/up, Mailpit, PostgreSQL, Redis, worker i scheduler; Horizon pozostaje planem                           | 05                        | DEV/OPS                | Uruchomienie od zera ≤30 min i brak prod danych                                         |
